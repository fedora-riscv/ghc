...
%install
cd %{buildroot}
mkdir -p .%{_bindir} .%{_libdir} .%{_docdir} .%{_mandir}/man1 .%{_localstatedir}/lib
for i in \
%ifarch x86_64
...
%endif
%ifarch ppc64
%SOURCE10 %SOURCE111 %SOURCE112 %SOURCE113 %SOURCE114 %SOURCE115 %SOURCE116 %SOURCE117 %SOURCE118 %SOURCE119 %SOURCE120 %SOURCE121 %SOURCE122 %SOURCE123 %SOURCE124 %SOURCE125 %SOURCE126 %SOURCE127 %SOURCE128 %SOURCE129 %SOURCE130 %SOURCE131 %SOURCE132 %SOURCE133 %SOURCE134 %SOURCE135 %SOURCE136 %SOURCE137 %SOURCE138; do
%endif
    rpm2cpio $i | cpio --extract
done
cd -
